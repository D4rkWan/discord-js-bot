module.exports = {
  OWNER_IDS: ["692912861688758394", "1413671576640950312"], // Bot owner ID's
  SUPPORT_SERVER: "https://discord.gg/ADf7yDraCh", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1414746800560144508", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
